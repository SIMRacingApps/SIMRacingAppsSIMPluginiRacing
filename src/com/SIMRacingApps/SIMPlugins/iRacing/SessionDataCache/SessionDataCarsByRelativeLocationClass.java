...
public class SessionDataCarsByRelativeLocationClass extends SessionData {
    ...
    public SessionDataCarsByRelativeLocationClass(iRacingSIMPlugin SIMPlugin, SessionDataCars cars) {
        super(SIMPlugin, "CarsByRelativeLocationClass", -1, "integer",State.OFF);
