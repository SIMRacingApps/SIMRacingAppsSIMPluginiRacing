...
/**
 * Returns the Fuel Pressure of the car  
 */

public class VarDataDoubleFuelPress extends VarDataDouble {
     ...
     */
    public VarDataDoubleFuelPress(IODriver IODriver, iRacingCar car) {
        super(IODriver,car,"FuelPress","kPa");
    }
