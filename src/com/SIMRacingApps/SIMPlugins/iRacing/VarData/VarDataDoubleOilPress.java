...
/**
 * Returns the Oil Pressure of the car  
 */

public class VarDataDoubleOilPress extends VarDataDouble {
    private static final long serialVersionUID = 6880022730773814381L;
     ...
     */
    public VarDataDoubleOilPress(IODriver IODriver, iRacingCar car) {
        super(IODriver,car,"OilPress","kPa");
    }
